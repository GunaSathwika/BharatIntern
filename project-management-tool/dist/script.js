...
createProjectButton.addEventListener("click", () => {
    // You can implement project creation logic here
    // Add the new project to the 'projects' array and update the display
    displayProjects();
});
...
assignTaskButton.addEventListener("click", () => {
    // You can implement task assignment logic here
